...
class Test_EntrySummary2():
    randomInvoice = "ABTstTC2_VslNCnt_"+ utills.random_invoceGenerator() # random_invoceGenerator() came from utils
    ...
    def test_TC2_SimpleEntry_VesselWithoutContainer(self): # Country of origin india/No Duty HTS(NDC)
        self.log.info("----------------Test Case test_TC2_SimpleEntry_VesselWithoutContainer Starterd----------------")
        ...
        self.log.info("----------------Test Case test_TC2_SimpleEntry_VesselWithoutContainer End----------------")



# pytest -v -s testcases/test_EntryTC2.py
# pytest -v -s testcases/test_EntryTC2.py --browser chrome
# pytest -v -s testcases/test_EntryTC2.py --browser firefox
# pytest -v -s --html=reports\EntryTC2Report.html testcases/test_EntryTC2.py
# pytest -v --html=reports\EntryTC2Report.html testcases/test_EntryTC2.py
# pytest -v --html=reports\EntryTC2Report.html testcases/test_EntryTC2.py --browser chrome   #if in html report if logs are not getting genrated then remove -s and try