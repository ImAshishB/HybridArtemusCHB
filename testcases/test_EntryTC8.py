...
class Test_EntrySummary8():
    randomInvoice = "ABTstTC8_InfrmlVsl_"+ utills.random_invoceGenerator() # random_invoceGenerator() came from utils
    ...
    def test_TC8_Informal_Vessel_Container(self): # Country of origin india/No Duty HTS(NDC)
        self.log.info("----------------Test Case test_TC8_Informal_Vessel_Container with Container Starterd----------------")
        ...
        for r in range(10, 11):
            ...
            if 'Form saved succesfully!' in self.msg:
                ...
                # self.driver.save_screenshot(".\\screenshots\\" + "test_HTC8_scr.png")  # Screenshot
                self.esf.formSavedConfirmationMsg()
                self.log.error("----Form Not Saved. Test Failed----")

        self.log.info("----------------Test Case test_TC8_Informal_Vessel_Container with Container End----------------")



# pytest -v -s testcases/test_EntryTC8.py
# pytest -v -s testcases/test_EntryTC8.py --browser chrome
# pytest -v -s testcases/test_EntryTC8.py --browser firefox
# pytest -v -s --html=reports\EntryTC8Report.html testcases/test_EntryTC8.py
# pytest -v --html=reports\EntryTC8Report.html testcases/test_EntryTC8.py
# pytest -v --html=reports\EntryTC8Report.html testcases/test_EntryTC8.py --browser chrome   #if in html report if logs are not getting genrated then remove -s and try