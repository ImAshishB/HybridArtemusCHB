...
class Test_EntrySummary15():
    randomInvoice = "ABTestTC15"+ utills.random_invoceGenerator() # random_invoceGenerator() came from utils
    ...
    def test_TC15_2FPGA_Vessel_Container(self):
        ...
        for r in range(17, 18):
            ...
            self.EP5descriptionData = utills.readData(self.file, "Sheet1", r, 40)
            self.EP5desclaimerdata = utills.readData(self.file, "Sheet1", r, 41)
