...
class Test_DEMO2(): # for class the Test name should be in capital
    ...
    def test_DEMOTC_03_UpperPart(self): # Country of origin india/No Duty HTS(NDC)
        self.log.info("----------------Test Case test_DEMOTC_03_UpperPart Starterd----------------")
        ...
        self.log.info("----------------Test Case test_DEMOTC_03_UpperPart End----------------")

    @pytest.mark.regression
    def test_DEMOTC_04_vesselInfo(self): # Country of origin india/No Duty HTS(NDC)
        self.log.info("----------------Test Case test_DEMOTC_04_vesselInfo Starterd----------------")
        ...
        self.log.info("----------------Test Case test_DEMOTC_04_vesselInfo End----------------")
