...
class Test_EntrySummary12():
    randomInvoice = "ABTstTC12_CN_"+ utills.random_invoceGenerator() # random_invoceGenerator() came from utils
    ...
    def test_TC12_China_SimpleEntry_Vessel_Container(self): # Country of origin india/No Duty HTS(NDC)
        self.log.info("----------------Test Case test_TC12_China_SimpleEntry_Vessel_Container with Container Starterd----------------")
        ...
        for r in range(14, 15):
            ...
            if 'Form saved succesfully!' in self.msg:
                ...
                # self.driver.save_screenshot(".\\screenshots\\" + "test_HTC12_scr.png")  # Screenshot
                self.esf.formSavedConfirmationMsg()
                self.log.error("----Form Not Saved. Test Failed----")

        self.log.info("----------------Test Case test_TC12_China_SimpleEntry_Vessel_Container with Container End----------------")



# pytest -v -s testcases/test_EntryTC12.py
# pytest -v -s testcases/test_EntryTC12.py --browser chrome
# pytest -v -s testcases/test_EntryTC12.py --browser firefox
# pytest -v -s --html=reports\EntryTC12Report.html testcases/test_EntryTC12.py
# pytest -v --html=reports\EntryTC12Report.html testcases/test_EntryTC12.py
# pytest -v --html=reports\EntryTC12Report.html testcases/test_EntryTC12.py --browser chrome   #if in html report if logs are not getting genrated then remove -s and try