...
class Test_EntrySummary4():
    ...
    def test_TC4_SimpleEntry_Air_WithoutContainer(self): # Country of origin india/No Duty HTS(NDC)
        self.log.info("----------------Test Case test_TC4_SimpleEntry_Air with Container Starterd----------------")
        ...
        self.log.info("----------------Test Case test_TC4_SimpleEntry_Air with Container End----------------")



# pytest -v -s testcases/test_EntryTC4.py
# pytest -v -s testcases/test_EntryTC4.py --browser chrome
# pytest -v -s testcases/test_EntryTC4.py --browser firefox
# pytest -v -s --html=reports\EntryTC4Report.html testcases/test_EntryTC4.py
# pytest -v --html=reports\EntryTC4Report.html testcases/test_EntryTC4.py
# pytest -v --html=reports\EntryTC4Report.html testcases/test_EntryTC4.py --browser chrome   #if in html report if logs are not getting genrated then remove -s and try